...
namespace Business.Concrete
{
    public class MailParameterManager: IMailParameterService
    {
        ...
        public IDataResult<MailParameter> Get(int storeID)
        {
            return new SuccessDataResult<MailParameter>(_mailParameterDal.Get(c=>c.StoreID== storeID));
        }

        public IResult Update(MailParameter mailParameter)
        {
            var result = Get(mailParameter.StoreID);
            if (result.Data == null)
            {
            ...
            {
                //result.Data.ID = mailParameter.ID;
                //result.Data.StoreID = mailParameter.StoreID;
